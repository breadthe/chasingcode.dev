<section class="mt-8">
    ...
    <a href="javascript:void(0);"
            ...
            class="bg-mastodon-purple social--share--icon no-underline text-lg text-white hover:text-white rounded font-mono px-2 py-1"
    >Mastodon</a>

    <a href="https://twitter.com/share?url={{ $page->getUrl() }}&text={{ $page->description }}&via={{ $page->twitterHandle }}"
       style="background: #55acee;"
       class="social--share--icon no-underline text-lg text-white hover:text-white rounded font-mono px-2 py-1"
    >Twitter</a>
